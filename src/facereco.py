...
#Tkinter
root = tk.Tk()
root.title("Smart Pharmacy Fridge Login")
#Frames
...
tk.Label(loginFrame,text="Smart Pharmacy Face Recognition",font=("Courier", 30),bg="white").grid(row=1,column=1,columnspan=5)
